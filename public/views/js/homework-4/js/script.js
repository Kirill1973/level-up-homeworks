...
for (var i = 0; i < 5; ++i) alert( i ); // цикл начинается с 0, увеличиваясь каждый раз и так до 5, но при этом возвращает старое значение.
for (var i = 0; i < 5; i++) alert( i ); //   цикл начинается с 0, увеличиваясь каждый раз и так до 5.
